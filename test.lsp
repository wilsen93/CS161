...
(defun final-state (s)
  (cond ((not (= (length s) 3)) NIL) ;if the state doesnt have 3 members
...
(defun next-state (s m c)
  (cond ((or (> (+ m c) 2) (or (< (first s) m) (< (second s) c))) NIL)
	((> (- (second s) c) (- (first s) m)) NIL) ; #of c > m on this side
	((> (+ (- 3 (second s)) c) (+ (- 3 (first s)) m)) m) 0)) NIL) ; #of c > m on the other side
...
;(append (next-state s 1 0) (next-state s 0 1) (next-state s 2 0) (next-state s 0 2) (next-state s 1 1))) 
